...
このウェブサイトは[Kubernetes SIG Docs](/ja/docs/contribute/#get-involved-with-sig-docs)が管理しています。
...
- 正確さと言語の校正のため、他のKubernetesコミュニティメンバーから[プルリクエストのレビュー](/ja/docs/contribute/review/reviewing-prs/)を受けてください。
...
- [ページコンテンツの種類](/docs/contribute/style/page-content-types/)と[Hugoショートコード](/ja/docs/contribute/style/hugo-shortcodes/)について勉強してください。
...
- [Kubernetesコミュニティサイト](/ja/community/)を訪問してください。TwitterやStack Overflowに参加したり、Kubernetesの集会やイベントについて学んだりしてください。
